...
export const CatalogSection = () => {
  ...
  const [modalTitle, setModalTitle] = React.useState("Получить консультацию")

  function openModal(itemName: string) {
    setModalTitle(`Заказать: ${itemName}`)
    setModalOpen(true)
  }
              ...
              <Card key={i} className="border-orange-100 hover:border-orange-300 transition-colors">
                ...
                <CardContent>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button onClick={() => openModal(item.name)} size="sm" className="bg-orange-500 hover:bg-orange-600 text-white text-xs">
                      Заказать
                    </Button>
                  </div>
                </CardContent>
          ...
          {[
            ...
            <Card key={i} className="border-orange-100 hover:border-orange-300 transition-colors">
              ...
              <CardContent>
                ...
                <Button onClick={() => openModal(service.title)} className="mt-4 bg-orange-500 hover:bg-orange-600 text-white" size="sm">
                  Узнать подробнее
                </Button>
              </CardContent>
            </Card>
...
export const CtaSection = () => {
  ...
  function openConsult() {
    setModalTitle("Получить консультацию")
    setModalOpen(true)
  }

  function openCalc() {
    setModalTitle("Рассчитать стоимость")
    setModalOpen(true)
  }
      ...
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <div className="bg-orange-500/10 rounded-[14px] border border-orange-200 p-0.5">
            <Button onClick={openConsult} size="lg" className="rounded-xl px-8 text-base bg-orange-500 hover:bg-orange-600 text-white">
              Получить консультацию
            </Button>
          </div>
          <Button onClick={openCalc} size="lg" variant="outline" className="rounded-xl px-8 border-orange-200 hover:text-orange-500">
